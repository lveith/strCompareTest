...
If ($calledBy#Current method name:C684)  // isSelfLauched
	...
	$processId:=New process:C317(Current method name:C684;0;"localVarCompareTest";Current method name:C684;*)
	If ($processId#0)
...
Else 
	$winRef:=Open form window:C675("localVarCompareTest")
	...
	SET WINDOW TITLE:C213("compare test 'Form.str1' vs. '$t1' | "+$info4D)
	DIALOG:C40("localVarCompareTest")
